...
public class HashTableClaseMetodos extends HashTableClase {
    private int SIZE = 16;
    private int ITEMS = 0;
    private HashEntry[] entries = new HashEntry[SIZE];

    public static void main(String[] args) {
        HashTableClaseMetodos hashTable = new HashTableClaseMetodos();
        ...
        HashTableClaseMetodos.log("****   HashTable  ***");
        HashTableClaseMetodos.log(hashTable.toString());
        HashTableClaseMetodos.log("\nValue for key(20) : " + hashTable.get("20"));
    }
